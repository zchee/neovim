...
--- @field on_bytes_batch? fun(_: "bytes", bufnr: integer, events: {
---   changedtick: integer, start_row: integer, start_col: integer, start_byte: integer,
---   old_row: integer, old_col: integer, old_byte: integer, new_row: integer, new_col: integer,
---   new_byte: integer, preview: boolean
--- }): boolean?
