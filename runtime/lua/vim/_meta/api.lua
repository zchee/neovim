...
--- - on_bytes_batch: Lua callback invoked on change.
---   Receives a list of change tables containing the fields listed for
---   `on_bytes`, plus a `preview` boolean indicating if the edit occurred during
---   |cmdpreview|. Return a truthy value (not `false` or `nil`) to detach. Args:
---   - the string "bytes"
---   - buffer id
---   - array of change tables
