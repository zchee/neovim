...
set(MSGPACK_CONFIGURE_COMMAND ${CMAKE_COMMAND} ${DEPS_BUILD_DIR}/src/msgpack
  ...
  "-DCMAKE_C_FLAGS:STRING=${CMAKE_C_COMPILER_ARG1} -fPIC -march=native -Ofast -pipe -flto"
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_C_COMPILER_ARG1} -fPIC -march=native -Ofast -pipe -flto"
