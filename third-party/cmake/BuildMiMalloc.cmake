ExternalProject_Add(mimalloc
  ...
  BUILD_COMMAND ${CMAKE_COMMAND} --build . --target mimalloc-static --config ${CMAKE_BUILD_TYPE}
  INSTALL_COMMAND ${CMAKE_COMMAND} --build . --target install --config ${CMAKE_BUILD_TYPE} &&
    cp ${DEPS_INSTALL_DIR}/lib/mimalloc-1.2/libmimalloc.a ${DEPS_INSTALL_DIR}/lib/libmimalloc.a &&
    cp ${DEPS_INSTALL_DIR}/lib/mimalloc-1.2/include/mimalloc.h ${DEPS_INSTALL_DIR}/include/mimalloc.h &&
    cp ${DEPS_INSTALL_DIR}/lib/mimalloc-1.2/include/mimalloc-override.h ${DEPS_INSTALL_DIR}/include/mimalloc-override.h)
